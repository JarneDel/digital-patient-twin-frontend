  ...
  <div class="flex flex-row justify-between gap-4">
    <div class="flex flex-row">
      <button
        ...
        class=" overflow-hidden px-3 py-3 ring-2 text-tertiary-600 ring-transparent transition-all duration-300 ease-out outline-none focus-visible:ring-tertiary-600"
        :class="{
